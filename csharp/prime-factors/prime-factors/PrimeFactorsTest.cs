...
public class PrimeFactorsTest
{
    ...
    public void Test_Primes()
    {
        ...
        Assert.That(primes.Nth(0), Is.EqualTo(2));
        Assert.That(primes.Nth(1), Is.EqualTo(3));
        Assert.That(primes.Nth(2), Is.EqualTo(5));
        Assert.That(primes.Nth(3), Is.EqualTo(7));
        Assert.That(primes.Nth(4), Is.EqualTo(11));
    }
}