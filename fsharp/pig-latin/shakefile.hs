...
soln_name = "PigLatin"
src_file  = "PigLatin.fs"
tst_file  = "PigLatinTests.fs"
...
soln_full = joinPath [soln_name, soln_name <.> "sln"]
exercise  = joinPath [src_dir, src_file]
msbuild   = show $ joinPath ["C:\\", "Program Files (x86)", "MSBuild", "12.0", "Bin", "MSBuild.exe"]
nunit     = joinPath [soln_name, "packages", "NUnit.Runners.2.6.4", "tools", "nunit-console.exe"]
