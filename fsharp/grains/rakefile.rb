...
SOLUTION_FILE = 'Grains.sln'
SOLUTION = File.join(SOLUTION_DIR, SOLUTION_FILE)

EXERCISE_DIR  = File.join(SOLUTION_DIR, 'Grains')
EXERCISE_FILE = 'Grains.fs'
EXERCISE = File.join(EXERCISE_DIR, EXERCISE_FILE)
TESTS = File.join(EXERCISE_DIR, 'GrainsTest.fs')

OUTPUT_DIR  = File.join(EXERCISE_DIR, 'bin', 'Debug')
OUTPUT_FILE = 'Grains.dll'
